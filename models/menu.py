...
response.menu = [
    ...
    (T('Pai do Cheque'), False, URL('pessoa', 'index'), []),
    
]

if auth.has_membership('admin'):
    response.menu += [
    (T('Cheques'), False, URL('cheque', 'index', args=[data.month,data.year]), []),
    (T('Recebimentos'), False, URL('recebimento', 'index', args=[data.month,data.year]), []),
    ]
    
if True:
    response.menu += [
    (T('Lista dos Inativos'), False, URL('pessoa', 'inativos'), [])
    ]
# ----------------------------------------------------------------------------------------------------------------------
